...
const Sidebar: React.FC = () => {
    ...
    const storageService = new StorageService(); // Load the API settings when the sidebar is opened
    ...
    useEffect(() => {
        loadAISettings(); // Set up message listener for Chrome messages
